        ...
        <body>
            <div class='email-container'>
                ...
                <div class='body'>
                    ...
                    <p><strong>Trạng Thái:</strong> {(invoice.IsPaid ? "Đã Thanh Toán" : "Chưa Thanh Toán")}</p>
                    <p>Vui lòng thanh toán hóa đơn trước ngày <strong>{billingPeriod}</strong> để tránh bị phạt trễ hạn.</p>
